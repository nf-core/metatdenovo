...
- [#NN](https://github.com/nf-core/metatdenovo/pull/NN) - Replace the local `COLLECT_FEATURECOUNTS` module with the shared `nf-core/modules` component `custom/collectfeaturecounts`; no change to the output tables themselves, addresses [nf-core/magmap#237](https://github.com/nf-core/magmap/issues/237) (@erikrikarddaniel)
