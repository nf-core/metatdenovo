...
- [#NNN](https://github.com/nf-core/metatdenovo/pull/NNN) - Fix the eggNOG-mapper version reported by conda runs, which was the pipeline's own release tag instead of the tool's version (@erikrikarddaniel)
