...
- [#528](https://github.com/nf-core/metatdenovo/pull/528) - Move `docs/large_datasets.md` to `docs/usage/large_datasets.md` so the "Coping with large datasets" page is actually published on the website, at `/metatdenovo/<version>/docs/usage/large_datasets/`. It previously existed on GitHub but returned 404 on nf-co.re, leaving the six links to it from `docs/usage.md` -- the pipeline's guidance on assembly memory problems -- dead there, addresses [#493](https://github.com/nf-core/metatdenovo/issues/493) (@erikrikarddaniel)
