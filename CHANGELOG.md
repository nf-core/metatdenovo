...
- [#NN](https://github.com/nf-core/metatdenovo/pull/NN) - Document how to build a taxonomy-aware Diamond database with nf-core/createtaxdb, addresses [#412](https://github.com/nf-core/metatdenovo/issues/412) (@erikrikarddaniel)
