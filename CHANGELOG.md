...
- [#NN](https://github.com/nf-core/metatdenovo/pull/NN) - Document why BBMap, rather than e.g. Bowtie2, is used for read mapping and contaminant removal in `conf/modules.config` (@erikrikarddaniel)
